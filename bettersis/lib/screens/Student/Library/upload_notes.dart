...
class _UploadNotesPageState extends State<UploadNotesPage> {
    ...
    if (_existingMaterialUrl != null) {
      final shouldOverwrite = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('A Lecture Note already exists. Do you want to overwrite it?'),
          actions: [
            TextButton(
  ...
  Future<void> _uploadMaterial() async {
    ...
    try {
      final storagePath = 'Library/notes/${_selectedDepartment}/${_selectedProgram}/${_selectedSemester}/${_selectedCourse}';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Select Note Image'),
