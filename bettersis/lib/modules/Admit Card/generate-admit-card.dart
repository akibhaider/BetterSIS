...
class _GenerateAdmitCardState extends State<GenerateAdmitCard> {
  ...
  final filePath = "${output.path}/admit_card.pdf"; // File path in Documents directory
  ...
  final String generatedDate = DateFormat('dd-MM-yyyy HH:mm:ss').format(DateTime.now());
        ...
        return pw.Column(
          ...
          children: [
            ...
            pw.Row(
              ...
              children: [
                pw.Image(pw.MemoryImage(iutLogoData.buffer.asUint8List()), width: 50, height: 50),
                pw.Image(pw.MemoryImage(oicLogoData.buffer.asUint8List()), width: 50, height: 50),
              ],
            ),
